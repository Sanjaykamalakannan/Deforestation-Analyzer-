...
export const FireIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM10 10a1 1 0 01-1 1H7a1 1 0 110-2h2a1 1 0 011 1zm3 5a1 1 0 100-2h.01a1 1 0 100 2H13z" clipRule="evenodd" />
        <path d="M10 4a1 1 0 10-2 0v.01a1 1 0 102 0V4zm3 5a1 1 0 10-2 0v.01a1 1 0 102 0V9zm2 4a1 1 0 10-2 0v.01a1 1 0 102 0v-.01z" />
    </svg>
);
...
export const AreaIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        <path d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm3 1a1 1 0 000 2h3a1 1 0 000-2H5zM5 9a1 1 0 000 2h5a1 1 0 000-2H5zM5 13a1 1 0 000 2h7a1 1 0 000-2H5z" />
    </svg>
);
